...
import com.system.demo.controllers.dashboard.OffenseController;
...
public class MainController {
    ...
    private void openDashboardWindow(ActionEvent event, String role) {
        try {
            ...
            // Set user role for the appropriate controller
            if ("admin".equals(role)) {
                TableViewController controller = loader.getController();
                controller.setUserRole(role);
            } else {
                OffenseController controller = loader.getController();
                controller.setUserRole(role);
            }
